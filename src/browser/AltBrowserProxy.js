...
const IAB = {
    ...
    injectScriptFile: function (win, fail, args) {
        const msg = 'Browser cordova-plugin-altbrowser injectScriptFile is not yet implemented';
        console.warn(msg);
        if (fail) {
            fail(msg);
        }
    ...
    injectStyleCode: function (win, fail, args) {
        const msg = 'Browser cordova-plugin-altbrowser injectStyleCode is not yet implemented';
        console.warn(msg);
        if (fail) {
            fail(msg);
        }
    ...
    injectStyleFile: function (win, fail, args) {
        const msg = 'Browser cordova-plugin-altbrowser injectStyleFile is not yet implemented';
        console.warn(msg);
        if (fail) {
            fail(msg);
        }
...
require('cordova/exec/proxy').add('AltBrowser', module.exports);
